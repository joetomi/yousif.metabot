translations = {
    'en': {
        ...
        'messenger_fallback_lbl': 'Fallback Response (AI Offline)',
        'messenger_fallback_desc': 'This message is sent if the Gemini API key is missing or if the AI service fails.',
        ...
        'subscription_updated': 'Subscription expiration updated!',
        'password_updated': 'Password updated successfully!',
        'access_denied': 'Access denied. Developer role required.',
        'change_password': 'Change Password',
        'toggle_status': 'Toggle Status',
        'extend_sub': 'Extend Subscription',
    ...
    'ar': {
        ...
        'messenger_fallback_lbl': 'الرد الاحتياطي (عند توقف الذكاء الاصطناعي)',
        'messenger_fallback_desc': 'هذه الرسالة يتم إرسالها للزبون في حال لم يتم إدخال مفتاح Gemini أو عند حدوث عطل في الخدمة.',
        ...
        'developer': 'مطور',
        'user': 'عميل',
        'no_users': 'لا يوجد عملاء مسجلين حالياً.',
        'user_added_success': 'تم إضافة العميل بنجاح!',
        'user_deleted_success': 'تم حذف العميل بنجاح!',
        'user_status_updated': 'تم تحديث حالة العميل بنجاح!',
        'subscription_updated': 'تم تحديث تاريخ انتهاء الاشتراك!',
        'password_updated': 'تم تحديث كلمة المرور بنجاح!',
        'access_denied': 'تم رفض الوصول. مطلوب صلاحية المطور.',
        'change_password': 'تغيير كلمة المرور',
        'toggle_status': 'تغيير حالة النشاط',
        'extend_sub': 'تمديد الاشتراك',
        'delete_user': 'حذف العميل',
        'confirm_delete_user': 'هل أنت متأكد من رغبتك في حذف هذا العميل نهائياً؟'
    }
}
